...
<Link to={"/"} className="flex items-center gap-2"> <HiMiniArrowTrendingUp className="w-8 h-8 text-blue-400 stroke-1"/> <span className="font-bold text-xl tracking-wide">Price Tracker</span> </Link>
    ...
    <div className="hidden md:flex items-center gap-8">
      ...
      <a onClick={(e) => {
          ...
          }} className="hover:text-blue-200 transition cursor-pointer">Track Product</a>
