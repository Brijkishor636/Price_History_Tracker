      ...
      <div className="w-full flex flex-col items-center justify-center py-10">
        <form className="md:w-96 w-80 flex flex-col items-center justify-center p-5 px-10 rounded-lg bg-linear-to-br from-pink-50 to-blue-100">
          ...
          <button
            ...
            type="button"
            className="w-full hover:bg-gray-300 cursor-pointer mt-8 bg-gray-500/10 flex items-center justify-center h-12 rounded-full"
          >
            <img
          ...
          <button
            ...
            type="button"
            className="w-full hover:bg-gray-300 cursor-pointer mt-3 bg-gray-500/10 flex items-center justify-center h-12 rounded-full"
          >
            <img
