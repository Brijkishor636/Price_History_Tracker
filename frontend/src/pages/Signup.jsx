      ...
      <div className="flex-grow w-full flex flex-col md:flex-row min-h-screen">
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center py-10 px-4 md:px-10">
          ...
          >
            ...
            <div className="flex items-center w-full bg-transparent border border-gray-600 h-12 rounded-full overflow-hidden pl-6 gap-2 mt-4">
            ...
            <div className="flex items-center mt-4 w-full bg-transparent border border-gray-600 h-12 rounded-full overflow-hidden pl-6 gap-2">
            ...
            <div className="w-full flex items-center mt-4 text-gray-400">
              <input
              ...
              <label className="text-sm" htmlFor="terms">
                I agree to the <a className="underline text-indigo-400 hover:text-indigo-300" href="#">Terms & Conditions</a>
              </label>
            </div>

            <button
              type="submit"
              className="mt-6 w-full h-11 rounded-full text-white bg-indigo-500 hover:bg-indigo-600 transition-all"
            >
              Sign Up
            </button>
          ...
          <div className="text-center">
            <div className="flex flex-col items-center justify-center text-5xl font-extrabold mb-4 text-indigo-400">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16 mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <path strokeLinecap="round" strokeLinejoin="round" d="M3 17a2 2 0 012-2h14a2 2 0 012 2v2a2 2 0 01-2 2H5a2 2 0 01-2-2v-2z" />
              </svg>
